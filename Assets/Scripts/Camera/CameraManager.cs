...
public class CameraManager : Singleton<CameraManager>
{
    ...
    public void Start()
    {
        ...
        {
            RaceUiManagers[0].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth,
                VirtualHeight * 2);
            RaceUiManagers[1].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth,
                VirtualHeight * 2);
        ...
        {
            RaceUiManagers[0].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth * 2,
                VirtualHeight * 2);
            RaceUiManagers[1].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth * 2,
                VirtualHeight * 2);
            RaceUiManagers[2].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth,
                VirtualHeight * 2);
        ...
        if (RaceUiManagers.Count == 4)
        {
            ...
            RaceUiManagers[1].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth * 2,
                VirtualHeight * 2);
            RaceUiManagers[2].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth * 2,
                VirtualHeight * 2);
            RaceUiManagers[3].GetComponent<CanvasScaler>().referenceResolution = new Vector2(VirtualWidth * 2,
                VirtualHeight * 2);
            RaceUiManagers[0].GetComponent<Canvas>().worldCamera.rect = new Rect(0, 0.5f, 0.5f, 0.5f);
            RaceUiManagers[1].GetComponent<Canvas>().worldCamera.rect = new Rect(0.5f, 0.5f, 0.5f, 0.5f);
